...
CREATE TABLE IF NOT EXISTS `app_schema` (
  ...
  `checksum` timestamp NULL DEFAULT NULL COMMENT '{"archetype": "AUDIT_TIMESTAMP", "title": "Checksum"}',
...
INSERT INTO `app_schema` (`table_name`, `schema_json`, `checksum`, `creado_por`, `fecha_creacion`, `modificado_por`, `fecha_modificacion`, `is_deleted`, `deleted_by`, `fecha_eliminacion`) VALUES
	('clientes', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"clientes","label":"Cliente","labelPlural":"Clientes","defaultSortColumn":"nombre_razon_social","actions":{"table":[{"label":"Nuevo Cliente"}],"row":[{"label":"Ver Proyectos","icon":"folder-open","targetRoute":"\\/app\\/clientes\\/{primaryKey}\\/proyectos"},{"label":"Editar","action":"openEditForm"},{"label":"Eliminar","action":"triggerDelete"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"cotizador_asignado_id":{"archetype":"SELECT_API","title":"Cotizador Asignado","optionsSource":{"endpoint":"usuarios","params":{"rol_id":400},"valueKey":"id","labelKey":"nick"}},"nombre_razon_social":{"archetype":"TEXT_REQUIRED","title":"Nombre o Raz\\u00f3n Social","validation":{"minLength":3}},"nit_ci":{"archetype":"TEXT_GENERAL","title":"NIT\\/CI"},"telefono":{"archetype":"TEXT_GENERAL","title":"Tel\\u00e9fono","inputType":"tel"},"email":{"archetype":"TEXT_GENERAL","title":"Email","inputType":"email"},"direccion":{"archetype":"TEXTAREA","title":"Direcci\\u00f3n"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('config_cotizacion', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"config_cotizacion","label":"Configuraci\\u00f3n de Cotizaci\\u00f3n","labelPlural":"Configuraciones de Cotizaci\\u00f3n","actions":{"table":[{"label":"A\\u00f1adir Regla"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"cotizacion_id":{"archetype":"SELECT_API","title":"Cotizaci\\u00f3n","optionsSource":{"endpoint":"cotizaciones","valueKey":"id","labelKey":"nombre_version"},"validation":{"required":true}},"familia_id":{"archetype":"SELECT_API","title":"Para la Familia","optionsSource":{"endpoint":"familias","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"producto_proveedor_id_preferido":{"archetype":"SELECT_API","title":"Usar Producto\\/Proveedor Espec\\u00edfico","optionsSource":{"endpoint":"productos_proveedor","valueKey":"id","labelKey":"id"},"validation":{"required":true}},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('cotizacion_detalle', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"cotizacion_detalle","label":"\\u00cdtem de Cotizaci\\u00f3n","labelPlural":"Detalle de Cotizaci\\u00f3n","actions":{"table":[{"label":"A\\u00f1adir \\u00cdtem"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"cotizacion_id":{"archetype":"SELECT_API","title":"Cotizaci\\u00f3n","optionsSource":{"endpoint":"cotizaciones","valueKey":"id","labelKey":"nombre_version"},"validation":{"required":true}},"vano_id":{"archetype":"SELECT_API","title":"Vano Medido","optionsSource":{"endpoint":"vanos","valueKey":"id","labelKey":"codigo_vano"},"validation":{"required":true}},"tipologia_id":{"archetype":"SELECT_API","title":"Producto (Tipolog\\u00eda)","optionsSource":{"endpoint":"tipologias","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"costo_calculado":{"archetype":"NUMBER","title":"Costo Calculado","isEditable":false},"precio_venta":{"archetype":"NUMBER","title":"Precio de Venta"},"notas":{"archetype":"TEXTAREA","title":"Notas del \\u00cdtem"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('cotizaciones', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"cotizaciones","label":"Cotizaci\\u00f3n","labelPlural":"Cotizaciones","actions":{"table":[{"label":"Nueva Cotizaci\\u00f3n"}],"row":[{"label":"Ver Detalle","targetRoute":"\\/app\\/cotizaciones\\/{primaryKey}\\/detalle"},{"label":"Generar OT","action":"triggerGenerateOT","condition":{"field":"estado","value":"Aprobada"}},{"label":"Editar","action":"openEditForm"},{"label":"Eliminar","action":"triggerDelete"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"proyecto_id":{"archetype":"SELECT_API","title":"Proyecto","optionsSource":{"endpoint":"proyectos","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"nombre_version":{"archetype":"TEXT_REQUIRED","title":"Nombre de la Versi\\u00f3n","placeholder":"Ej: Opci\\u00f3n A: Aluminio Blanco"},"total_costo":{"archetype":"NUMBER","title":"Costo Total","isEditable":false},"total_venta":{"archetype":"NUMBER","title":"Venta Total","isEditable":false},"estado":{"archetype":"SELECT_STATIC","title":"Estado","optionsSource":{"staticData":[{"value":"En Borrador","label":"En Borrador"},{"value":"Presentada","label":"Presentada"},{"value":"Aprobada","label":"Aprobada"},{"value":"Rechazada","label":"Rechazada"}]}},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('familia_tipos', '{"archetype":"CATALOGO_BASICO","tableName":"familia_tipos","label":"Tipo de Familia","labelPlural":"Tipos de Familia","actions":{"table":[{"label":"Nuevo Tipo"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"nombre":{"archetype":"TEXT_REQUIRED","title":"Nombre del Tipo"},"descripcion":{"archetype":"TEXTAREA","title":"Descripci\\u00f3n"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('familias', '{"archetype":"CATALOGO_BASICO","tableName":"familias","label":"Familia","labelPlural":"Familias","actions":{"table":[{"label":"Nueva Familia"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"nombre":{"archetype":"TEXT_REQUIRED","title":"Nombre de Familia"},"familia_tipo_id":{"archetype":"SELECT_API","title":"Tipo","optionsSource":{"endpoint":"familia_tipos","valueKey":"id","labelKey":"nombre"}},"descripcion":{"archetype":"TEXTAREA","title":"Descripci\\u00f3n"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('historial_cambios', '{"archetype":"TABLA_SISTEMA","tableName":"historial_cambios","primaryKey":"id","label":"Historial de Cambio","labelPlural":"Historial de Cambios","columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"fecha_hora":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha y Hora","visible":true,"showInEditForm":true},"usuario_id":{"archetype":"SELECT_API","title":"Usuario","isEditable":false,"optionsSource":{"endpoint":"usuarios","valueKey":"id","labelKey":"nick"}},"accion":{"archetype":"TEXT_GENERAL","title":"Acci\\u00f3n","isEditable":false},"tabla_afectada":{"archetype":"TEXT_GENERAL","title":"Tabla Afectada","isEditable":false},"registro_id":{"archetype":"NUMBER","title":"ID del Registro","isEditable":false},"valor_anterior":{"archetype":"TEXTAREA","title":"Valor Anterior","isEditable":false,"visible":false},"valor_nuevo":{"archetype":"TEXTAREA","title":"Valor Nuevo","isEditable":false,"visible":false}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('materiales', '{"archetype":"CATALOGO_BASICO","tableName":"materiales","label":"Material","labelPlural":"Materiales","actions":{"table":[{"label":"Nuevo Material"}],"row":[{"label":"Ver Precios","targetRoute":"\\/app\\/materiales\\/{primaryKey}\\/precios"},{"label":"Editar","action":"openEditForm"},{"label":"Eliminar","action":"triggerDelete"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"familia_id":{"archetype":"SELECT_API","title":"Familia","optionsSource":{"endpoint":"familias","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"codigo_interno":{"archetype":"TEXT_REQUIRED","title":"C\\u00f3digo Interno"},"nombre":{"archetype":"TEXT_REQUIRED","title":"Nombre del Material"},"unidad_calculo_id":{"archetype":"SELECT_API","title":"Unidad de C\\u00e1lculo","optionsSource":{"endpoint":"unidades","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"unidad_calculo":{"archetype":"SYSTEM_FLAG"},"descripcion":{"archetype":"TEXTAREA","title":"Descripci\\u00f3n"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('medidas_produccion', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"medidas_produccion","label":"Medida de Producci\\u00f3n","labelPlural":"Medidas de Producci\\u00f3n","actions":{"table":[],"row":[{"label":"Editar Medida","action":"openEditForm"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"orden_trabajo_id":{"archetype":"NUMBER","title":"OT ID","isEditable":false},"vano_cotizado_id":{"archetype":"NUMBER","title":"Vano ID","isEditable":false},"ancho_cotizado":{"archetype":"NUMBER","title":"Ancho Cotizado","isEditable":false},"alto_cotizado":{"archetype":"NUMBER","title":"Alto Cotizado","isEditable":false},"ancho_final":{"archetype":"NUMBER","title":"Ancho Final"},"alto_final":{"archetype":"NUMBER","title":"Alto Final"},"medido_por_id":{"archetype":"SELECT_API","title":"Medido Por","isEditable":false,"optionsSource":{"endpoint":"usuarios","params":{"rol_id":500},"valueKey":"id","labelKey":"nick"}},"fecha_medicion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Medici\\u00f3n"},"estado_medicion":{"archetype":"TEXT_GENERAL","title":"Estado","isEditable":false},"notas_fabricacion":{"archetype":"TEXTAREA","title":"Notas para Taller"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('ordenes_trabajo', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"ordenes_trabajo","label":"Orden de Trabajo","labelPlural":"\\u00d3rdenes de Trabajo","actions":{"table":[],"row":[{"label":"Medici\\u00f3n Final","targetRoute":"\\/app\\/ordenes-trabajo\\/{primaryKey}\\/medicion"},{"label":"Ver Despiece","targetRoute":"\\/app\\/ordenes-trabajo\\/{primaryKey}\\/despiece"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"cotizacion_aprobada_id":{"archetype":"NUMBER","title":"Cotizaci\\u00f3n de Origen","isEditable":false},"codigo_orden":{"archetype":"TEXT_REQUIRED","title":"C\\u00f3digo OT"},"responsable_id":{"archetype":"SELECT_API","title":"Jefe de Producci\\u00f3n","optionsSource":{"endpoint":"usuarios","valueKey":"id","labelKey":"nick","filterByRole":{"300":{"rol_id_in":[500]},"200":{"rol_id_gt":200},"default":{"rol_id":300}}}},"fecha_inicio_produccion":{"archetype":"TEXT_GENERAL","title":"Inicio Producci\\u00f3n","inputType":"date"},"estado":{"archetype":"TEXT_GENERAL","title":"Estado","isEditable":false},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	...
	('permisos', '{"archetype":"CATALOGO_BASICO","tableName":"permisos","label":"Regla de Permiso","labelPlural":"Reglas de Permisos","primaryKey":"id","actions":{"table":[{"label":"Nueva Regla"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"rol_id":{"archetype":"SELECT_API","title":"Rol Afectado","optionsSource":{"endpoint":"roles","valueKey":"id","labelKey":"nombre"}},"usuario_id":{"archetype":"SELECT_API","title":"Usuario Espec\\u00edfico","placeholder":"(Opcional) Aplicar solo a este usuario","optionsSource":{"table":"usuarios","value":"id","label":"nick"}},"tabla_afectada":{"archetype":"TEXT_REQUIRED","title":"Tabla Afectada"},"tipo_regla":{"archetype":"SELECT_STATIC","title":"Tipo de Regla","optionsSource":{"staticData":[{"value":"visibility","label":"Visibilidad (Filtra Filas)"},{"value":"schema","label":"Esquema (Oculta Columnas\\/Botones)"},{"value":"action","label":"Acci\\u00f3n (Valida Escritura)"}]}},"regla_json":{"archetype":"TEXTAREA","title":"Definici\\u00f3n de la Regla (JSON)"},"descripcion":{"archetype":"TEXTAREA","title":"Descripci\\u00f3n"},"is_active":{"archetype":"CHECKBOX","title":"Activa"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', '2025-09-19 05:04:20', NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('productos_proveedor', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"productos_proveedor","label":"Producto de Proveedor","labelPlural":"Productos de Proveedor","actions":{"table":[{"label":"Nuevo Precio"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"material_id":{"archetype":"SELECT_API","title":"Material","optionsSource":{"endpoint":"materiales","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"proveedor_id":{"archetype":"SELECT_API","title":"Proveedor","optionsSource":{"endpoint":"proveedores","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"color":{"archetype":"TEXT_GENERAL","title":"Color"},"codigo_proveedor":{"archetype":"TEXT_GENERAL","title":"C\\u00f3d. Proveedor"},"precio":{"archetype":"NUMBER","title":"Precio","validation":{"required":true}},"moneda":{"archetype":"SELECT_STATIC","title":"Moneda","optionsSource":{"staticData":[{"value":"Bs","label":"Bolivianos (Bs)"},{"value":"USD","label":"D\\u00f3lares (USD)"}]}},"unidad_compra_id":{"archetype":"SELECT_API","title":"Unidad de Compra","optionsSource":{"endpoint":"unidades","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"unidad_compra":{"archetype":"SYSTEM_FLAG"},"dimension_compra":{"archetype":"NUMBER","title":"Dimensi\\u00f3n de Compra","placeholder":"Ej: 6.0 para una barra de 6m"},"es_preferido":{"archetype":"CHECKBOX","title":"Preferido"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('proveedores', '{"archetype":"CATALOGO_BASICO","tableName":"proveedores","label":"Proveedor","labelPlural":"Proveedores","actions":{"table":[{"label":"Nuevo Proveedor"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"nombre":{"archetype":"TEXT_REQUIRED","title":"Nombre del Proveedor"},"direccion":{"archetype":"TEXTAREA","title":"Direcci\\u00f3n"},"telefono":{"archetype":"TEXT_GENERAL","title":"Tel\\u00e9fono","inputType":"tel"},"email":{"archetype":"TEXT_GENERAL","title":"Email","inputType":"email"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('proyectos', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"proyectos","label":"Proyecto","labelPlural":"Proyectos","defaultSortColumn":"nombre","actions":{"table":[{"label":"Nuevo Proyecto"}],"row":[{"label":"Relevamiento","icon":"ruler-combined","targetRoute":"\\/app\\/proyectos\\/{primaryKey}\\/relevamiento"},{"label":"Ver Cotizaciones","icon":"file-invoice-dollar","targetRoute":"\\/app\\/proyectos\\/{primaryKey}\\/cotizaciones"},{"label":"Editar","action":"openEditForm"},{"label":"Eliminar","action":"triggerDelete"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"cliente_id":{"archetype":"SELECT_API","title":"Cliente","optionsSource":{"endpoint":"clientes","valueKey":"id","labelKey":"nombre_razon_social"},"validation":{"required":true}},"nombre":{"archetype":"TEXT_REQUIRED","title":"Nombre del Proyecto"},"direccion":{"archetype":"TEXTAREA","title":"Direcci\\u00f3n del Proyecto"},"estado":{"archetype":"SELECT_STATIC","title":"Estado","optionsSource":{"staticData":[{"value":"En Relevamiento","label":"En Relevamiento"},{"value":"En Cotizaci\\u00f3n","label":"En Cotizaci\\u00f3n"},{"value":"Aprobado","label":"Aprobado"},{"value":"En Producci\\u00f3n","label":"En Producci\\u00f3n"},{"value":"Finalizado","label":"Finalizado"},{"value":"Cancelado","label":"Cancelado"}]}},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', '2025-09-19 05:09:22', NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('recetas_despiece', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"recetas_despiece","label":"\\u00cdtem de Receta","labelPlural":"Receta de Despiece","actions":{"table":[{"label":"A\\u00f1adir Material"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"tipologia_id":{"archetype":"SELECT_API","title":"Tipolog\\u00eda","optionsSource":{"endpoint":"tipologias","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"material_id":{"archetype":"SELECT_API","title":"Material","optionsSource":{"endpoint":"materiales","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"descripcion_item":{"archetype":"TEXT_GENERAL","title":"Descripci\\u00f3n del \\u00cdtem","placeholder":"Ej: Perfil de jamba lateral"},"formula_cantidad":{"archetype":"TEXT_REQUIRED","title":"F\\u00f3rmula Cantidad","placeholder":"Ej: 2, $Dv"},"formula_corte_ancho":{"archetype":"TEXT_GENERAL","title":"F\\u00f3rmula Corte Ancho (X)","placeholder":"Ej: $A + $c"},"formula_corte_alto":{"archetype":"TEXT_GENERAL","title":"F\\u00f3rmula Corte Alto (Y)","placeholder":"Ej: $h \\/ 2"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('roles', '{"columns":{"id":[],"codigo":[],"nombre":[],"descripcion":[],"nivel_jerarquia":[],"creado_por":[],"fecha_creacion":[],"modificado_por":[],"fecha_modificacion":[],"is_deleted":[],"deleted_by":[],"fecha_eliminacion":[]}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('tipologias', '{"archetype":"CATALOGO_BASICO","tableName":"tipologias","label":"Tipolog\\u00eda","labelPlural":"Tipolog\\u00edas","actions":{"table":[{"label":"Nueva Tipolog\\u00eda"}],"row":[{"label":"Editar Receta","icon":"blender","targetRoute":"\\/app\\/tipologias\\/{primaryKey}\\/receta"},{"label":"Editar","action":"openEditForm"},{"label":"Eliminar","action":"triggerDelete"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"nombre":{"archetype":"TEXT_REQUIRED","title":"Nombre de Tipolog\\u00eda"},"familia_principal_id":{"archetype":"SELECT_API","title":"Familia Principal","optionsSource":{"endpoint":"familias","valueKey":"id","labelKey":"nombre"}},"num_divisiones_verticales":{"archetype":"NUMBER","title":"Divisiones Verticales","defaultValue":1},"num_divisiones_horizontales":{"archetype":"NUMBER","title":"Divisiones Horizontales","defaultValue":1},"num_hojas_moviles":{"archetype":"NUMBER","title":"Hojas M\\u00f3viles","defaultValue":0},"imagen_path":{"archetype":"TEXT_GENERAL","title":"Ruta de Imagen","placeholder":"Ej: \\/images\\/disenos\\/L25-V-C-2-1-1.png"},"notas_diseno":{"archetype":"TEXTAREA","title":"Notas de Dise\\u00f1o"},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
	('ubicaciones', '{"archetype":"ENTIDAD_PRINCIPAL","tableName":"ubicaciones","label":"Ubicaci\\u00f3n","labelPlural":"Ubicaciones","defaultSortColumn":"piso","actions":{"table":[{"label":"Nueva Ubicaci\\u00f3n"}],"row":[{"label":"A\\u00f1adir Vanos","targetRoute":"\\/app\\/ubicaciones\\/{primaryKey}\\/vanos"},{"label":"Editar","action":"openEditForm"},{"label":"Eliminar","action":"triggerDelete"}]},"columns":{"id":{"archetype":"PRIMARY_KEY","title":"ID"},"proyecto_id":{"archetype":"SELECT_API","title":"Proyecto","optionsSource":{"endpoint":"proyectos","valueKey":"id","labelKey":"nombre"},"validation":{"required":true}},"piso":{"archetype":"TEXT_GENERAL","title":"Piso \\/ Nivel","placeholder":"Ej: Planta Baja, Piso Tipo"},"departamento":{"archetype":"TEXT_GENERAL","title":"Departamento \\/ Bloque","placeholder":"Ej: Dpto A, Bloque B"},"ambiente":{"archetype":"TEXT_REQUIRED","title":"Ambiente","placeholder":"Ej: Cocina, Sala"},"referencia":{"archetype":"TEXT_GENERAL","title":"Referencia Adicional","placeholder":"Ej: Fachada Oeste"},"cantidad":{"archetype":"NUMBER","title":"Ubicaciones Iguales","defaultValue":1,"validation":{"required":true}},"creado_por":{"archetype":"AUDIT_USER"},"fecha_creacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Creaci\\u00f3n"},"modificado_por":{"archetype":"AUDIT_USER"},"fecha_modificacion":{"archetype":"AUDIT_TIMESTAMP","title":"\\u00daltima Modificaci\\u00f3n"},"is_deleted":{"archetype":"SYSTEM_FLAG"},"deleted_by":{"archetype":"AUDIT_USER"},"fecha_eliminacion":{"archetype":"AUDIT_TIMESTAMP","title":"Fecha Eliminaci\\u00f3n"}}}', NULL, NULL, '2025-09-19 05:16:22', NULL, '2025-09-19 05:16:22', 0, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `permisos` (
  ...
  `usuario_id` int(11) DEFAULT NULL COMMENT '{"archetype":"SELECT_API","title":"Usuario Específico","placeholder":"(Opcional) Aplicar solo a este usuario","optionsSource":{"table":"usuarios","value":"id","label":"nick"}}',
  `tabla_afectada` varchar(64) NOT NULL COMMENT '{"archetype": "TEXT_REQUIRED", "title": "Tabla Afectada"}',
  `tipo_regla` enum('visibility','schema','action','menu_item') NOT NULL COMMENT '{"archetype": "SELECT_STATIC", "title": "Tipo de Regla", "optionsSource": {"staticData": [{"value": "visibility", "label": "Visibilidad (Filtra Filas)"}, {"value": "schema", "label": "Esquema (Oculta Columnas/Botones)"}, {"value": "action", "label": "Acción (Valida Escritura)"}]}}',
...
) ENGINE=InnoDB AUTO_INCREMENT=117 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='{"archetype": "CATALOGO_BASICO", "tableName": "permisos", "label": "Regla de Permiso", "labelPlural": "Reglas de Permisos", "primaryKey": "id", "actions": {"table": [{"label": "Nueva Regla"}]}}';

-- Volcando datos para la tabla librosandinos_vitrales_v2.permisos: ~112 rows (aproximadamente)
INSERT INTO `permisos` (`id`, `rol_id`, `usuario_id`, `tabla_afectada`, `tipo_regla`, `regla_json`, `descripcion`, `is_active`, `creado_por`, `fecha_creacion`, `modificado_por`, `fecha_modificacion`, `is_deleted`, `deleted_by`, `fecha_eliminacion`) VALUES
	(1, 4, NULL, 'app_schema', 'visibility', '{"type": "deny_all"}', 'Admin: Acceso denegado a la tabla interna de esquemas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(2, 6, NULL, 'app_schema', 'visibility', '{"type": "deny_all"}', 'Jefe de Prod: Acceso denegado a la tabla interna de esquemas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(3, 10, NULL, 'app_schema', 'visibility', '{"type": "deny_all"}', 'Cotizador: Acceso denegado a la tabla interna de esquemas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(4, 11, NULL, 'app_schema', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a la tabla interna de esquemas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(5, 14, NULL, 'app_schema', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a la tabla interna de esquemas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(6, 15, NULL, 'app_schema', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a la tabla interna de esquemas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(7, 10, NULL, 'clientes', 'visibility', '{"type": "field_match", "field": "cotizador_asignado_id", "value": "{userId}"}', 'Cotizador: Solo puede ver los clientes que tiene asignados.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(8, 10, NULL, 'clientes', 'schema', '{"hide_columns_in_table": ["cotizador_asignado_id"], "field_overrides": {"cotizador_asignado_id": {"showInCreateForm": false, "showInEditForm": false, "defaultValueOnCreate": "{userId}"}}}', 'Cotizador: Oculta columna de cotizador y auto-asigna al crear.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(9, 6, NULL, 'clientes', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a la tabla de clientes.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(10, 14, NULL, 'clientes', 'visibility', '{"type": "field_match", "field": "id", "value": "{clientId}"}', 'Cliente: Solo puede ver su propia información de cliente.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(11, 6, NULL, 'config_cotizacion', 'visibility', '{"type": "deny_all"}', 'Jefe de Prod: Acceso denegado a la configuración de cotizaciones.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(12, 11, NULL, 'config_cotizacion', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(13, 14, NULL, 'config_cotizacion', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(14, 15, NULL, 'config_cotizacion', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(15, 6, NULL, 'cotizaciones', 'visibility', '{"type": "deny_all"}', 'Jefe de Prod: Acceso denegado a cotizaciones.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(16, 10, NULL, 'cotizaciones', 'action', '{"prevent_update_if": {"field": "estado", "not_in": ["En Borrador"]}, "prevent_delete_if": {"field": "estado", "not_in": ["En Borrador"]}}', 'Cotizador: No puede modificar cotizaciones que no estén en borrador.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(17, 11, NULL, 'cotizaciones', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a cotizaciones.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(18, 14, NULL, 'cotizaciones', 'visibility', '{"type": "subquery", "field": "proyecto_id", "operator": "IN", "subquery": {"from_table": "proyectos", "select_field": "id", "where": {"field": "cliente_id", "value": "{clientId}"}}}', 'Cliente: Solo ve cotizaciones de sus proyectos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(19, 15, NULL, 'cotizaciones', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a cotizaciones.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(20, 6, NULL, 'cotizacion_detalle', 'visibility', '{"type": "deny_all"}', 'Jefe de Prod: Acceso denegado a detalle de cotización.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(21, 10, NULL, 'cotizacion_detalle', 'action', '{"prevent_write_if_parent_status": {"parent_table": "cotizaciones", "parent_key": "cotizacion_id", "status_field": "estado", "not_in": ["En Borrador"]}}', 'Cotizador: No puede modificar el detalle de cotizaciones que no estén en borrador.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(22, 11, NULL, 'cotizacion_detalle', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a detalle de cotización.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(23, 15, NULL, 'cotizacion_detalle', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a detalle de cotización.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(24, 10, NULL, 'familias', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cotizador: Acceso de solo lectura al catálogo de familias.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(25, 11, NULL, 'familias', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a familias.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(26, 14, NULL, 'familias', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a familias.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(27, 15, NULL, 'familias', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a familias.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(28, 6, NULL, 'familia_tipos', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a tipos de familia.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(29, 10, NULL, 'familia_tipos', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cotizador: Acceso de solo lectura a tipos de familia.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(30, 11, NULL, 'familia_tipos', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a tipos de familia.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(31, 14, NULL, 'familia_tipos', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a tipos de familia.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(32, 15, NULL, 'familia_tipos', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a tipos de familia.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(33, 10, NULL, 'materiales', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cotizador: Acceso de solo lectura al catálogo de materiales.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(34, 11, NULL, 'materiales', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a materiales.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(35, 14, NULL, 'materiales', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a materiales.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(36, 15, NULL, 'materiales', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a materiales.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(37, 6, NULL, 'productos_proveedor', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a precios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(38, 10, NULL, 'productos_proveedor', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cotizador: Acceso de solo lectura a precios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(39, 11, NULL, 'productos_proveedor', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a precios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(40, 14, NULL, 'productos_proveedor', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a precios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(41, 15, NULL, 'productos_proveedor', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a precios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(42, 6, NULL, 'proveedores', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a proveedores.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(43, 10, NULL, 'proveedores', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cotizador: Acceso de solo lectura a proveedores.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(44, 11, NULL, 'proveedores', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a proveedores.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(45, 14, NULL, 'proveedores', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a proveedores.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(46, 15, NULL, 'proveedores', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a proveedores.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(47, 6, NULL, 'unidades', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a unidades.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(48, 10, NULL, 'unidades', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cotizador: Acceso de solo lectura a unidades.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(49, 11, NULL, 'unidades', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a unidades.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(50, 14, NULL, 'unidades', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a unidades.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(51, 15, NULL, 'unidades', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a unidades.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(52, 4, NULL, 'historial_cambios', 'visibility', '{"type": "deny_all"}', 'Admin: Acceso denegado al historial de cambios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(53, 6, NULL, 'historial_cambios', 'visibility', '{"type": "deny_all"}', 'Jefe de Prod: Acceso denegado al historial de cambios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(54, 10, NULL, 'historial_cambios', 'visibility', '{"type": "deny_all"}', 'Cotizador: Acceso denegado al historial de cambios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(55, 11, NULL, 'historial_cambios', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado al historial de cambios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(56, 14, NULL, 'historial_cambios', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado al historial de cambios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(57, 15, NULL, 'historial_cambios', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado al historial de cambios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(58, 4, NULL, 'permisos', 'visibility', '{"type": "deny_all"}', 'Admin: Acceso denegado a la gestión de permisos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(59, 6, NULL, 'permisos', 'visibility', '{"type": "deny_all"}', 'Jefe de Prod: Acceso denegado a la gestión de permisos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(60, 10, NULL, 'permisos', 'visibility', '{"type": "deny_all"}', 'Cotizador: Acceso denegado a la gestión de permisos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(61, 11, NULL, 'permisos', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a la gestión de permisos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(62, 14, NULL, 'permisos', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a la gestión de permisos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(63, 15, NULL, 'permisos', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a la gestión de permisos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(64, 4, NULL, 'roles', 'visibility', '{"type": "deny_all"}', 'Admin: Acceso denegado a la gestión de roles.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(65, 6, NULL, 'roles', 'visibility', '{"type": "deny_all"}', 'Jefe de Prod: Acceso denegado a la gestión de roles.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(66, 10, NULL, 'roles', 'visibility', '{"type": "deny_all"}', 'Cotizador: Acceso denegado a la gestión de roles.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(67, 11, NULL, 'roles', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a la gestión de roles.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(68, 14, NULL, 'roles', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a la gestión de roles.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(69, 15, NULL, 'roles', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a la gestión de roles.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(70, 10, NULL, 'medidas_produccion', 'visibility', '{"type": "deny_all"}', 'Cotizador: Acceso denegado a las medidas de producción.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(71, 11, NULL, 'medidas_produccion', 'schema', '{"hide_actions": ["openCreateForm", "triggerDelete"]}', 'Técnico: Solo puede editar medidas, no crearlas ni eliminarlas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(72, 14, NULL, 'medidas_produccion', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a las medidas de producción.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(73, 15, NULL, 'medidas_produccion', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a las medidas de producción.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(74, 6, NULL, 'ordenes_trabajo', 'schema', '{"hide_actions": ["openCreateForm", "triggerDelete"]}', 'Jefe de Prod: Puede editar OTs, pero no crearlas ni eliminarlas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(75, 10, NULL, 'ordenes_trabajo', 'visibility', '{"type": "deny_all"}', 'Cotizador: Acceso denegado a las órdenes de trabajo.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(76, 11, NULL, 'ordenes_trabajo', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Técnico: Acceso de solo lectura a las órdenes de trabajo.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(77, 14, NULL, 'ordenes_trabajo', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cliente: Acceso de solo lectura a sus OTs.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(78, 15, NULL, 'ordenes_trabajo', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a las órdenes de trabajo.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(79, 10, NULL, 'recetas_despiece', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cotizador: Acceso de solo lectura a las recetas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(80, 11, NULL, 'recetas_despiece', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a las recetas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(81, 14, NULL, 'recetas_despiece', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a las recetas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(82, 15, NULL, 'recetas_despiece', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a las recetas.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(83, 10, NULL, 'tipologias', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cotizador: Acceso de solo lectura a las tipologías.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(84, 11, NULL, 'tipologias', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a las tipologías.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(85, 14, NULL, 'tipologias', 'visibility', '{"type": "deny_all"}', 'Cliente: Acceso denegado a las tipologías.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(86, 15, NULL, 'tipologias', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a las tipologías.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(87, 6, NULL, 'proyectos', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a proyectos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(88, 11, NULL, 'proyectos', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a proyectos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(89, 14, NULL, 'proyectos', 'visibility', '{"type": "field_match", "field": "cliente_id", "value": "{clientId}"}', 'Cliente: Solo ve sus propios proyectos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(90, 14, NULL, 'proyectos', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cliente: Acceso de solo lectura a proyectos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(91, 15, NULL, 'proyectos', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a proyectos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(92, 6, NULL, 'ubicaciones', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a ubicaciones.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(93, 11, NULL, 'ubicaciones', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a ubicaciones.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(94, 14, NULL, 'ubicaciones', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cliente: Acceso de solo lectura a ubicaciones.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(95, 15, NULL, 'ubicaciones', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a ubicaciones.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(96, 6, NULL, 'vanos', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a vanos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(97, 11, NULL, 'vanos', 'visibility', '{"type": "deny_all"}', 'Técnico: Acceso denegado a vanos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(98, 14, NULL, 'vanos', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Cliente: Acceso de solo lectura a vanos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(99, 15, NULL, 'vanos', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a vanos.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(100, 6, NULL, 'perfiles_usuario', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a perfiles.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(101, 10, NULL, 'perfiles_usuario', 'visibility', '{"type": "field_match", "field": "usuario_id", "value": "{userId}"}', 'Cotizador: Solo ve su propio perfil.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(102, 11, NULL, 'perfiles_usuario', 'visibility', '{"type": "field_match", "field": "usuario_id", "value": "{userId}"}', 'Técnico: Solo ve su propio perfil.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(103, 14, NULL, 'perfiles_usuario', 'visibility', '{"type": "field_match", "field": "usuario_id", "value": "{userId}"}', 'Cliente: Solo ve su propio perfil.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(104, 15, NULL, 'perfiles_usuario', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a perfiles.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(105, 6, NULL, 'usuarios', 'schema', '{"hide_actions": ["openCreateForm", "openEditForm", "triggerDelete"]}', 'Jefe de Prod: Acceso de solo lectura a usuarios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(106, 10, NULL, 'usuarios', 'visibility', '{"type": "field_match", "field": "id", "value": "{userId}"}', 'Cotizador: Solo ve su propio usuario.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(107, 10, NULL, 'usuarios', 'schema', '{"hide_actions": ["openCreateForm", "triggerDelete"]}', 'Cotizador: Solo puede editar su propio usuario.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(108, 11, NULL, 'usuarios', 'visibility', '{"type": "field_match", "field": "id", "value": "{userId}"}', 'Técnico: Solo ve su propio usuario.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(109, 11, NULL, 'usuarios', 'schema', '{"hide_actions": ["openCreateForm", "triggerDelete"]}', 'Técnico: Solo puede editar su propio usuario.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(110, 14, NULL, 'usuarios', 'visibility', '{"type": "field_match", "field": "id", "value": "{userId}"}', 'Cliente: Solo ve su propio usuario.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(111, 14, NULL, 'usuarios', 'schema', '{"hide_actions": ["openCreateForm", "triggerDelete"]}', 'Cliente: Solo puede editar su propio usuario.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(112, 15, NULL, 'usuarios', 'visibility', '{"type": "deny_all"}', 'Visitante: Acceso denegado a usuarios.', 1, NULL, '2025-09-03 05:58:43', NULL, '2025-09-03 05:58:43', 0, NULL, NULL),
	(113, 4, NULL, 'clientes', 'menu_item', '{"label": "Clientes", "order": 1}', NULL, 1, NULL, '2025-09-19 05:02:03', NULL, '2025-09-19 05:04:07', 0, NULL, NULL),
	(114, 4, NULL, 'cotizaciones', 'menu_item', '{"label": "Cotizaciones", "order": 2}', NULL, 1, NULL, '2025-09-19 05:02:03', NULL, '2025-09-19 05:04:11', 0, NULL, NULL),
	(115, 4, NULL, 'proyectos', 'menu_item', '{"label": "Proyectos", "order": 3}', NULL, 1, NULL, '2025-09-19 05:02:04', NULL, '2025-09-19 05:04:16', 0, NULL, NULL),
	(116, 4, NULL, 'config_cotizacion', 'menu_item', '{"label": "Configuraciones de Cotización", "order": 10}', NULL, 1, NULL, '2025-09-19 05:02:04', NULL, '2025-09-19 05:04:20', 0, NULL, NULL);
...
INSERT INTO `proyectos` (`id`, `cliente_id`, `nombre`, `direccion`, `estado`, `creado_por`, `fecha_creacion`, `modificado_por`, `fecha_modificacion`, `is_deleted`, `deleted_by`, `fecha_eliminacion`) VALUES
	(1, 1, 'Proyecto Principal Cliente ID 1', NULL, 'En Relevamiento', NULL, '2025-08-14 04:09:46', NULL, '2025-09-19 05:09:22', 1, 3, '2025-09-19 01:09:22'),
...
-- Volcando estructura para vista librosandinos_vitrales_v2.Auditoria
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `Auditoria` (
	`NombreTabla` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci',
	`NombreColumna` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci',
	`ComentarioColumna` VARCHAR(1) NOT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`librosandinos_mysql`@`200.%.%.%` SQL SECURITY DEFINER VIEW `Auditoria` AS select `C`.`TABLE_NAME` AS `NombreTabla`,`C`.`COLUMN_NAME` AS `NombreColumna`,`C`.`COLUMN_COMMENT` AS `ComentarioColumna` from (`information_schema`.`COLUMNS` `C` join `information_schema`.`TABLES` `T` on(`C`.`TABLE_NAME` = `T`.`TABLE_NAME` and `C`.`TABLE_SCHEMA` = `T`.`TABLE_SCHEMA`)) where `C`.`TABLE_SCHEMA` = database() and `T`.`TABLE_TYPE` = 'BASE TABLE' and `C`.`COLUMN_NAME` in ('creado_por','fecha_creacion','modificado_por','fecha_modificacion','is_deleted','deleted_by','fecha_eliminacion') order by `C`.`TABLE_NAME`,`C`.`ORDINAL_POSITION`
;
